...
Route::middleware(['auth', RoleMiddleware::class . ':admin'])->group(function () {
   ...
   Route::post('/admin/projects/save-reason', [DashboardController::class, 'saveReason'])->name('admin.projects.saveReason');
    Route::get('/admin/user-edit/{id}', [DashboardController::class, 'UserEdit'])->name('admin.user-edit');
//  Route::post('/admin/user-update', [DashboardController::class, 'UserUpdate'])->name('admin.user-update');
 Route::post('/admin/users/{id}/update', [DashboardController::class, 'UserUpdate'])->name('admin.update.user');
