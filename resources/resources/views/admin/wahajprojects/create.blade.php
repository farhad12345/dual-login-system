                ...
                <div class="container mt-5"  >
                    <div class="card shadow-sm" >
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0 text-center">إضافة مشروع وهج وطن جديد</h4>
...
<div class="col-md-6">
                                        ...
                                        <input type="number" name="area" placeholder="المساحة" id="area"
                                ...
                                <div class="row mb-3">
                                     <div class="col-md-6">
                                        ...
                                        <input type="number" name="width" placeholder="العرض" id="width"
                               ...
                               <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="height" placeholder="حدد تاريخ البدء" id="height"
                                ...
                                <div class="row mb-3">
                                  <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="number_of_floors" placeholder="عدد الادوار" id="number_of_floors"
