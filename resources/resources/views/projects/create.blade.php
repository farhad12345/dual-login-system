  <x-app-layout>
                                        ...
                                        <div class="container mt-5">
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    <form id="combinedForm" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div id="firstFormFields">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <!--</div>-->
                                                                       <div class="col-md-6">
                                                                    <label for="commertial_register_number" class="form-label">الرقم السجل التجاري</label>
                                                                    <input type="text" placeholder="رقم السجل التجاري" value="#" name="commertial_register_number" id="commertial_register_number"
                                                                        class="form-control @error('commertial_register_number') is-invalid @enderror" required>
                                                                    @error('commertial_register')
                                                                        <div class="invalid-feedback">
                                                                            {{ $message }}
                                                                        </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                 ...
                                                                 <div class="col-md-6">
                                                                    <label for="ministry" class="form-label">الجهه</label>
                                                                    <input type="text" name="ministry" placeholder="أدخل اسم الجهه" id="ministry"
                            ...
                            <option value="under_study">تحت الدراسه</option>
                            <option value="in_progress">في انتظار الطلبات</option>
                             <!--<option value="authority_review">تحت في انتظار الطلبات من طالب الخدمة </option>-->
                           <option value="authority_review"> في انتظار الطلبات من طالب الخدمة </option>
                           </select>
                            @error('status')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            @enderror
                                                        ...
                                                        <div id="secondFormFields" class="d-none">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="person_name" class="form-label">اسم المسوؤل</label>
                                                                    <input type="text" name="person_name" placeholder="أدخل  اسم المسوؤل" id="person_name"
