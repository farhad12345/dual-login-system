            ...
            <form id="combinedForm" action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="firstFormFields">
                    ...
                    <div class="row mb-3">
                        ...
                        <!--      <div class="col-md-6">-->
                        <!--    <label for="commertial_register" class="form-label"> اسجل التجاري</label>-->
                        <!--    <input type="text" placeholder=" لسجل التجاري" value="#" name="commertial_register" id="commertial_register"-->
                        ...
                        <!--</div>-->
                               <div class="col-md-6">
                            <label for="commertial_register" class="form-label">رقم السجل التجاري</label>
                            <input type="text" placeholder="رقم السجل التجاري" value="#" name="commertial_register" id="commertial_register"
                                class="form-control @error('commertial_register') is-invalid @enderror" required>
                            @error('commertial_register')
                                <div class="invalid-feedback">
                                    {{ $message }}
